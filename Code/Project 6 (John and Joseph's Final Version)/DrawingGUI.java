...
public class DrawingGUI extends Application {
    ...
    private String applicationBackgroundColorsHex;
    ...
    private static final int CENTER_HEIGHT = WINDOW_HEIGHT - 100;
    private static final int CENTER_WIDTH = WINDOW_WIDTH;
    ...
    private ColorPicker colorBackground = new ColorPicker();
    ...
    public void start(Stage primaryStage) throws Exception {
        // Defaults
        applicationBackgroundColorsHex = "#ffffff";
...
//        graphicsContext.fillRect(23, 42, 24, 12);
        ...
        // Background Color
        colorBackground.setValue(Color.web(applicationBackgroundColorsHex));
        colorBackground.setOnAction(this::setColorBackground);
//        colorBackground.setPadding(new Insets(0,0,0,20));
        colorBackground.setTooltip(new Tooltip("Background Color for Assignment Intended only!"));
        hBoxBottom.getChildren().add(colorBackground);
        ...
        comboBoxPenSize.setTooltip(new Tooltip("Pen Size"));
        ...
        colorPicker.setTooltip(new Tooltip("Pen Color"));
        ...
        checkBoxErase.setTooltip(new Tooltip("Eraser"));
        ...
        checkBoxClassicPen.setTooltip(new Tooltip("Pen similar to MSPaint and Adobe PhotoShop/Illustrator."));
        ...
        clearButton.setTooltip(new Tooltip("Clear Drawing board."));
        ...
        toggleButtonAssignment.setTooltip(new Tooltip("Button to switch between What the assignment intended and essentially the extra credit mode."));
...
//        primaryStage.heightProperty().addListener(this::handleOnResizeWindow); // like will run twice that all
    ...
    // Some of the colors do not work.. causing the CSS parser to throw an exception or an error?
    private void setColorBackground(ActionEvent event) {
        String color = colorBackground.getValue().toString();
        applicationBackgroundColorsHex = String.format("#%s", color.substring(2, 8));
//        System.out.println(applicationBackgroundColorsHex);

        // Will change canvas background color; however, erasing is by coloring the with the same background color.
//        stackPane.setStyle(String.format("-fx-background-color: %s;", applicationBackgroundColorsHex));
        assignmentPaneIntended.setStyle(String.format("-fx-background-color: %s;", applicationBackgroundColorsHex));
    }
