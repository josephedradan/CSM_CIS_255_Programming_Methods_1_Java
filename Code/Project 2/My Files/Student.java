...
public class Student {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof Student) {
            ...
            if (!this.firstName.equalsIgnoreCase(otherStudent.firstName)) {
                return false;
            }
            if (!this.lastName.equalsIgnoreCase(otherStudent.lastName)) {
                return false;
            }
            if (!this.tuitionPaid == otherStudent.tuitionPaid) {
                return false;
            }
            return true;
        } else {
